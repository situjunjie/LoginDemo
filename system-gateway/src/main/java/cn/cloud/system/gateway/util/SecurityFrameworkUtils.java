package cn.cloud.system.gateway.util;

import cn.hutool.core.map.MapUtil;
import cn.cloud.system.framework.common.util.json.JsonUtils;
import cn.cloud.system.gateway.filter.security.LoginUser;
 ...
 * 安全服务工具类
 *
 * copy from system-spring-boot-starter-security 的 SecurityFrameworkUtils 类
 *
 * 
 */
@Slf4j
