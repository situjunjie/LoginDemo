...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.cloud.demo";
    private static final String ARTIFACT_ID = "system";
    private static final String PACKAGE_NAME = "cn.cloud.system";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.cloud.demo";
        String artifactIdNew = "system";
        String packageNameNew = "cn.cloud.system";
        String titleNew = "土豆管理系统";
        String projectBaseDirNew = "D:\\test\\loginDemo"; // 一键改名后，“新”项目所在的目录
