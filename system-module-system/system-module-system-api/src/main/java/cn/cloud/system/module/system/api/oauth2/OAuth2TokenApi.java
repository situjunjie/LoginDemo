package cn.cloud.system.module.system.api.oauth2;
...
import cn.cloud.system.module.system.api.oauth2.dto.OAuth2AccessTokenCreateReqDTO;
import cn.cloud.system.module.system.api.oauth2.dto.OAuth2AccessTokenRespDTO;
...
public interface OAuth2TokenApi {
    ...
    @Parameters({
        ...
        @Parameter(name = "clientId", description = "客户端编号", required = true, example = "systemyuanma")
    })
