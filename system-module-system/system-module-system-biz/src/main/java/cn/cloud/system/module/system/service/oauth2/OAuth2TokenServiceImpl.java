package cn.cloud.system.module.system.service.oauth2;

import cn.cloud.system.framework.common.enums.UserTypeEnum;
import cn.cloud.system.framework.common.exception.enums.GlobalErrorCodeConstants;
import cn.cloud.system.framework.common.pojo.PageResult;
import cn.cloud.system.framework.common.util.date.DateUtils;
import cn.cloud.system.framework.common.util.object.BeanUtils;
import cn.cloud.system.framework.security.core.LoginUser;
import cn.cloud.system.module.system.controller.admin.oauth2.vo.token.OAuth2AccessTokenPageReqVO;
import cn.cloud.system.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import cn.cloud.system.module.system.dal.dataobject.oauth2.OAuth2RefreshTokenDO;
import cn.cloud.system.module.system.dal.dataobject.user.AdminUserDO;
import cn.cloud.system.module.system.dal.mysql.oauth2.OAuth2AccessTokenMapper;
import cn.cloud.system.module.system.dal.mysql.oauth2.OAuth2RefreshTokenMapper;
import cn.cloud.system.module.system.dal.redis.oauth2.OAuth2AccessTokenRedisDAO;
...
import static cn.cloud.system.framework.common.exception.util.ServiceExceptionUtil.exception0;
import static cn.cloud.system.framework.common.util.collection.CollectionUtils.convertSet;
...
public class OAuth2TokenServiceImpl implements OAuth2TokenService {
    ...
    public OAuth2AccessTokenDO createAccessToken(Long userId, Integer userType, String clientId, List<String> scopes) {
        // 创建刷新令牌
        OAuth2RefreshTokenDO refreshTokenDO = createOAuth2RefreshToken(userId, userType,DEFAULT_CLIENT , scopes);
        // 创建访问令牌
        return createOAuth2AccessToken(refreshTokenDO, DEFAULT_CLIENT);
    }
    ...
    private OAuth2AccessTokenDO createOAuth2AccessToken(OAuth2RefreshTokenDO refreshTokenDO, String ClientId) {
        OAuth2AccessTokenDO accessTokenDO = new OAuth2AccessTokenDO().setAccessToken(generateAccessToken())
                ...
                .setClientId(DEFAULT_CLIENT).setScopes(refreshTokenDO.getScopes())
                .setRefreshToken(refreshTokenDO.getRefreshToken())
                .setExpiresTime(LocalDateTime.now().plusSeconds(36000));
    ...
    private OAuth2RefreshTokenDO createOAuth2RefreshToken(Long userId, Integer userType, String clientId, List<String> scopes) {
        OAuth2RefreshTokenDO refreshToken = new OAuth2RefreshTokenDO().setRefreshToken(generateRefreshToken())
                ...
                .setClientId(DEFAULT_CLIENT).setScopes(scopes)
                .setExpiresTime(LocalDateTime.now().plusSeconds(36000));
    ...
    /**
     * 加载用户信息，方便 {@link cn.cloud.system.framework.security.core.LoginUser} 获取到昵称、部门等信息
     *
     * @param userId 用户编号
     * @param userType 用户类型
     * @return 用户信息
